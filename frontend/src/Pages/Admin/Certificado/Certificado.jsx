...
const templatesData = [
    { id: 1, name: "Certificado de Conclusão 2024", description: "Modelo oficial para conclusão de curso", lastModified: "2024-01-10", isActive: false },
    ...
    const handleViewDocument = (doc) => {
        if (doc.caminho_pdf) {
            setPreviewModal({
                isOpen: true,
                url: doc.caminho_pdf,
                title: `Certificado - ${doc.aluno_nome}`
            })
        }
    }
